...
class SdxServiceTest {
    ...
    void createSdx() {
        ...
        Pair<SdxCluster, FlowStartResponse> result = underTest.createSdx(USER_CRN, CLUSTER_NAME, sdxClusterRequest, null);
    ...
    void deleteSdxWhenCorrectNameIsProvided() {
        ...
        when(sdxReactorFlowManager.triggerSdxDeletion(anyLong(), anyBoolean())).thenReturn(FlowStartResponse.of("FLOW_ID", "FLOW_CHAIN_ID"));
