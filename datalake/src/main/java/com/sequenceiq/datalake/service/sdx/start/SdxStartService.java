...
public class SdxStartService {
    ...
    public FlowStartResponse triggerStartIfClusterNotRunning(SdxCluster cluster) {
    ...
    public void start(Long sdxId) {
        ...
        try {
            ...
            FlowStartResponse flowStartResponse = stackV4Endpoint.putStart(0L, sdxCluster.getClusterName());
