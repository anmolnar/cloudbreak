...
public class SdxStopService {
    ...
    public FlowStartResponse triggerStopIfClusterNotStopped(SdxCluster cluster) {
    ...
    public void stop(Long sdxId) {
        ...
        try {
            ...
            FlowStartResponse flowStartResponse = stackV4Endpoint.putStop(0L, sdxCluster.getClusterName());
