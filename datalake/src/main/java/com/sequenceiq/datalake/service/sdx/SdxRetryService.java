...
public class SdxRetryService {
    ...
    public FlowStartResponse retrySdx(SdxCluster sdxCluster) {
        ...
        return FlowRetryUtil.getMostRecentFailedLog(flowLogs)
                ...
                .map(lastSuccessfulStateLog -> {
                    ...
                    return FlowStartResponse.of(lastSuccessfulStateLog.getFlowId(), lastSuccessfulStateLog.getFlowChainId());
                })
