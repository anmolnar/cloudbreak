...
public class OperationRetryService {
    ...
    public FlowStartResponse retry(Long stackId) {
        ...
        if (lastSuccessfulStateFlowLog.isPresent()) {
            ...
            return FlowStartResponse.of(lastSuccessfulStateFlowLog.get().getFlowId(), lastSuccessfulStateFlowLog.get().getFlowChainId());
        } else {
