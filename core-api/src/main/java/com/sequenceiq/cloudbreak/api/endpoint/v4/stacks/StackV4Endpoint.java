...
public interface StackV4Endpoint {
    ...
    FlowStartResponse delete(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse retry(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name);
    ...
    FlowStartResponse putStop(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name);
    ...
    FlowStartResponse putStart(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name);
    ...
    FlowStartResponse putScaling(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name, @Valid StackScaleV4Request updateRequest);
    ...
    FlowStartResponse repairCluster(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse upgradeCluster(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name);
    ...
    FlowStartResponse changeImage(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse deleteWithKerberos(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @QueryParam("forced") @DefaultValue("false") boolean forced);
    ...
    FlowStartResponse deleteInstance(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse deleteMultipleInstances(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse putPassword(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse setClusterMaintenanceMode(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
    ...
    FlowStartResponse putCluster(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name, @Valid UpdateClusterV4Request updateJson);
