...
public class Stack implements ProvisionEntity, WorkspaceAwareResource {
    ...
    @Enumerated(EnumType.STRING)
    private DatabaseAvailabilityType externalDatabase;
    ...
    public DatabaseAvailabilityType getExternalDatabase() {
        return externalDatabase;
    }

    public void setExternalDatabase(DatabaseAvailabilityType externalDatabase) {
